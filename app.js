...
/* Emblema dourado estático com o símbolo de cada tipo (substitui as cenas animadas) */
function renderProds(type){
prodGrid.innerHTML = PRODUCTS[type].map(p=>
'<article class="prod-card">'+
'<div class="prod-head-static" style="display:flex;align-items:center;gap:14px;padding:24px 24px 6px">'+
'<span class="prod-emblem" style="width:60px;height:60px;flex:0 0 auto;border-radius:16px;display:grid;place-items:center;background:linear-gradient(150deg,#C5A059,#E8CC8B);box-shadow:0 8px 20px rgba(197,160,89,.30)"><svg viewBox="0 0 24 24" width="31" height="31" fill="none" stroke="#0D232B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'+p.ic+'</svg></span>'+
'<h3 style="margin:0;font-size:1.18rem;line-height:1.2;color:#F2FAF8">'+p.t+'</h3>'+
'</div>'+
...
const MANTER = 'h3,h4,.pilar-head,.dif-head,.strat-top,.prod-media,.prod-head-static,.how-num,.flow-num,.vic,.how-ico';
